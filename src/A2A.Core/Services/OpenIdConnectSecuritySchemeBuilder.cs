...
/// </summary>
public sealed class OpenIdConnectSecuritySchemeBuilder
    : IOpenIdConnectSecuritySchemeBuilder
{

    readonly OpenIdConnectSecurityScheme securityScheme = new();

    /// <inheritdoc/>
    public IOpenIdConnectSecuritySchemeBuilder WithUrl(Uri url)
    {
    ...
    /// <inheritdoc/>
    public OpenIdConnectSecurityScheme Build() => securityScheme;
