...
public sealed class A2AProtocolServer(ILogger<A2AProtocolServer> logger, IServiceProvider serviceProvider, IPushNotificationSender pushNotificationSender, IStateStore store, ITaskEventStream taskEvents, ITaskQueue taskQueue, IAgentRuntime agent)
    : IA2AProtocolServer
{
