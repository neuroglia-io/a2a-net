...
/// <summary>
/// Represents the default implementation of the <see cref="IA2APushNotificationSender"/> interface.
/// </summary>
public sealed class A2APushNotificationSender
    : IA2APushNotificationSender
{

    readonly ILogger<A2APushNotificationSender> logger;
    readonly IJsonWebKeySet jwks;
    readonly HttpClient httpClient;
    readonly RsaSecurityKey privateKey;

    /// <summary>
    /// Initializes a new <see cref="A2APushNotificationSender"/>.
    /// </summary>
    /// <param name="logger">The service used to perform logging</param>
    /// <param name="jwks">The service used to manage the application's JSON Web Key Set</param>
    /// <param name="httpClient">The service used to perform HTTP requests</param>
    public A2APushNotificationSender(ILogger<A2APushNotificationSender> logger, IJsonWebKeySet jwks, HttpClient httpClient)
    {
        this.logger = logger;
        this.jwks = jwks;
