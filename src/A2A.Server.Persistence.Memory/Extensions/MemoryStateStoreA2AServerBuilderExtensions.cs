...
/// </summary>
public static class MemoryStateStoreA2AServerBuilderExtensions
{

    /// <summary>
    /// Configures the <see cref="IA2AServer"/> to use the <see cref="MemoryStore"/> as its <see cref="IA2AStore"/>.
    /// </summary>
    /// <param name="builder">The <see cref="IA2AServerBuilder"/> to configure.</param>
    /// <param name="configure">An <see cref="Action{T}"/>, if any, used to configure the <see cref="MemoryStateStoreOptions"/> to use.</param>
