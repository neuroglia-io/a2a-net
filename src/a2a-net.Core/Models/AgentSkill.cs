...
public record AgentSkill
{
    ...
    /// <summary>
    /// Gets/sets the skill's unique identifier
    /// </summary>
    ...
    /// <summary>
    /// Gets/sets the skill's human readable name
    /// </summary>
    [Required, MinLength(1)]
    ...
    /// <summary>
    /// Gets/sets a human-readable description of the skill, if any<para></para>
    ...
    /// <summary>
    /// Gets/sets a set of tagwords, if any, used to describe classes of capabilities for this specific skill
    /// </summary>
    ...
    /// <summary>
    /// Gets/sets a set of example scenarios, if any, that the skill can perform<para></para>
