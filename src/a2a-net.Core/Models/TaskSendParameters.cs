...
public record TaskSendParameters
{
    ...
    /// <summary>
    /// Gets or sets the unique identifier of the session the task belongs to<para></para>
    ...
    /// <summary>
    /// Gets or sets the number of recent messages, if any, to be retrieved
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Gets or sets the configuration, if any, for the task's push notifications
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a key/value mapping that contains the request's additional properties, if any
    /// </summary>
