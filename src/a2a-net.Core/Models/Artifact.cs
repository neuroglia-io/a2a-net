...
public record Artifact
{
    ...
    /// <summary>
    /// Gets/sets a list containing the artifact's parts, if any
    /// </summary>
    ...
    /// <summary>
    /// Gets/sets the artifact's index
    /// </summary>
    ...
    /// <summary>
    /// Gets/sets a boolean indicating whether or not the artifact should be appended to the existing content
    /// </summary>
    ...
    /// <summary>
    /// Gets/sets a boolean indicating whether or not the artifact is the last chunk in a sequence
    /// </summary>
