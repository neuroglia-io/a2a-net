...
public record PushNotificationConfiguration
{
    ...
    /// <summary>
    /// Gets or sets the endpoint URL to which the push notification should be sent
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Gets or sets a token;, if any, that uniquely identifies the task or session associated with the push notification
    /// </summary>
    [DataMember(Name = "token", Order = 2), JsonPropertyName("token"), JsonPropertyOrder(2), YamlMember(Alias = "token", Order = 2)]
    public virtual string? Token { get; set; }

    /// <summary>
    /// Gets or sets information, if any, about the authentication used to push notification to the configured endpoint
    /// </summary>
