...
public sealed record GetTaskMethodParameters
{
    ...
    /// <summary>
    /// Gets the identifier of the tenant, if any, to which the task to get belongs.
    /// </summary>
    [Description("The identifier of the tenant, if any, to which the task to get belongs.")]
